 ...
 * 
 */
@WebServiceClient(name = "SoapServiceService", targetNamespace = "http://clases/", wsdlLocation = "http://localhost:7777/ws/SoapService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SOAPSERVICESERVICE_QNAME = new QName("http://clases/", "SoapServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:7777/ws/SoapService?wsdl");
    ...
    public SoapService getSoapServicePort() {
        return super.getPort(new QName("http://clases/", "SoapServicePort"), SoapService.class);
    }
    ...
    public SoapService getSoapServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://clases/", "SoapServicePort"), SoapService.class, features);
    }
